...
const Panel = ({ panel, tutup }) => {
  ...
  async function lanjut() {
    ...
    var interval = setInterval(
      () => localStorage.setItem("target", (no -= 1)),
      1000
    );
  }
  ...
  return (
    ...
    >
      ...
      <div style={{ color: "#efefef", marginBottom: 20 }}>
        <h4>Get latest updates in web technologies</h4>I write articles related
        to web technologies, such as design trends, development tools, UI/UX
        case studies and reviews, and more. Sign up to my newsletter to get them
        all.
      </div>
